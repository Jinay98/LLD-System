...
import com.lld.patterns.FactoryPattern.FactoryMethodPattern.models.small.PremiumSmallBurger;

public class SmallPremiumBurgerRestaurant extends BurgerRestaurant {
    @Override
    public Burger createBurger() {
        return new PremiumSmallBurger();
    }
}
