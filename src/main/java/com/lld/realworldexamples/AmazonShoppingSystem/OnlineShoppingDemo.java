...
import com.lld.realworldexamples.AmazonShoppingSystem.strategies.CreditCardPaymentStrategy;
import com.lld.realworldexamples.AmazonShoppingSystem.strategies.UPIPaymentStrategy;
...
public class OnlineShoppingDemo {
    public static void main(String[] args) {
        ...
        system.addToCart(alice.getId(), laptop, 1);
        System.out.println("Alice added a laptop to her cart.");

        // Alice adds a book to her cart
        system.addToCart(alice.getId(), book, 1);
        System.out.println("Alice added a book to her cart.");
        ...
        system.addToCart(bob.getId(), laptop, 15);
